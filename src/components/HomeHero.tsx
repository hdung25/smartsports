      ...
      <div className="relative h-full flex items-center">
        <div className="w-full max-w-container mx-auto px-5 sm:px-6 lg:pl-10 lg:pr-0">
          <div className="max-w-full sm:max-w-[80%] md:max-w-[55%] lg:max-w-[42%] text-white">
            ...
            <p className="mt-4 sm:mt-5 text-sm lg:text-base leading-relaxed text-white/90">
            ...
            <div className="mt-6 sm:mt-7 flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-3">
              <Link href="#bring" className="btn-orange text-xs lg:text-sm justify-center">
                Bring Smart Sports to Your Community
                <ArrowRight size={14} className="ml-2" />
              </Link>
              <Link
                href="#partner"
                className="btn border-2 border-white text-white hover:bg-white hover:text-brand-blue text-xs lg:text-sm justify-center"
              >
                Partner With Us
                <ArrowRight size={14} className="ml-2" />
              </Link>
